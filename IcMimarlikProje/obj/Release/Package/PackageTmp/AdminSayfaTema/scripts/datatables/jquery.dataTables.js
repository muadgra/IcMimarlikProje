...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlLength ( oSettings )
	{
		...
		nLength.innerHTML = '<a href="/admin/Articles/Create" class="btn btn-success" style="float:left"> Yeni Kayit</a> <label  style="float:left">'+oSettings.oLanguage.sLengthMenu.replace( '_MENU_', sStdMenu )+'</label>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "_TOTAL_ sayfadan _START_ ile _END_ kayit gosteriliyor",
